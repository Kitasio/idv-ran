      ...
      <div class="mt-5 grid lg:grid-cols-4 gap-x-14 text-lg">
          <div class="col-span-4 lg:col-span-3">
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  <div class="relative w-full" v-for="partner in partners" :key="partner.id">
                    ...
                    <Delete collection="partners" :docId="partner.id" :imgName="partner.imgName" />
                  </div>
              </div>
          </div>
...
export default {
  ...
  methods: {
      load: async function() {
          try {
              const res = projectFirestore.collection('partners')
      ...
      saveToDb: async function() {
            try {
                ...
                await projectFirestore.collection('partners').add(this.doc)
        ...
        const filePath = `partners/${file.name}`
